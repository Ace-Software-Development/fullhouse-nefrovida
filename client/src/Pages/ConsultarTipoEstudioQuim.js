/**
 * Consultar tipo de Estudio (Quimico):
 * En esta vista, el químico puede ver los detalles
 * del tipo de estudio, pero, a diferencia del administrador,
 * este no puede editar y ni eliminar el estudio. Sólo consultar
 * lo que contiene para revisar si está lo que necesita.
 * 
                ...
                <CardTitulo icono="description" titulo="Detalle del tipo de estudio"/>
                    ...
                    <br/><br/><br/><br/><br/>    
                        ...
                        <div className="col s7 l6 identificacion-prueba left-align">
                            ...
                            <div className="detalles-lista negrita-grande c-393939 left">Biometría Hemática</div><br/>
                            <div className="detalles-lista negrita-pequeno c-908F98 left">Examen de sangre que inspecciona las células que la componen</div>
                        </div>
